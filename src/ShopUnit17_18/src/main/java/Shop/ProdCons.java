...
import static Shop.Methods.createReport;
...
class Store{
    ...
    public synchronized void get() {
        ...
        createReport(this.products, "ShopUnit17_18/src/main/java/Shop/storeReport.txt");//в файл перезапишется список без удалённого продукта
    ...
    public synchronized void put(){
        ...
        productsAmount = products.size();
        createReport(this.products, "ShopUnit17_18/src/main/java/Shop/storeReport.txt");
