...
public class Methods {
    ...
    public static void serialize(Shop shop) {
        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("src/ShopUnit12_13/products.dat"))) {
    ...
    public static void deserialize(Shop shop) {
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream("src/ShopUnit12_13/products.dat"))) {
