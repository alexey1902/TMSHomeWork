...
public class Methods {
    ...
    public static void serialize(Shop shop) {
        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("src/Unit13/ShopConsole/products.dat"))) {
    ...
    public static void deserialize(Shop shop) {
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream("src/Unit13/ShopConsole/products.dat"))) {
